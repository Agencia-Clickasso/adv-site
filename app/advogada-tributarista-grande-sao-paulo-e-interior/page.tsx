...
export default function AdvogadaTributaristaGrandeSaoPauloPage() {
  return (
    <AreaPage
      ...
      highlights={[
        { title: "Como funciona", description: "Reuniões online e troca de documentos digital, com acompanhamento por etapa." },
        { title: "Onde o escritório está", description: "São Bernardo do Campo, no ABC paulista." },
        { title: "Quando faz sentido", description: "Operações interestaduais, tributos municipais e decisões fiscais fora do eixo da capital." },
      ]}
      services={[
        {
          icon: TrendingUp,
          title: "Planejamento e regime",
          description: "Análise de regime tributário e estrutura conforme a realidade da operação regional.",
          features: ["Comparativo de regimes", "Estrutura societária", "Planejamento de expansão", "Revisão de carga"],
        },
        {
          icon: Landmark,
          title: "ICMS e operações interestaduais",
          description: "Questões de ICMS que aparecem quando a empresa vende ou transfere para outros estados.",
          features: ["DIFAL em vendas a consumidor final", "DIFAL no Simples Nacional", "Transferência entre estabelecimentos", "ICMS em energia solar"],
        },
        {
          icon: FileSearch,
          title: "Defesa fiscal",
          description: "Resposta a autuações e cobranças, inclusive em execuções fiscais e dívida ativa.",
          features: ["Auto de infração", "Execução fiscal", "PARR e responsabilidade tributária", "Transação tributária"],
        },
        {
          icon: Building2,
          title: "Setores específicos",
          description: "Leitura tributária por setor, com atenção às particularidades de cada operação.",
          features: ["Clínicas e saúde", "Agronegócio (FUNRURAL, SENAR, ITR)", "Comércio e serviços", "Indústria e insumos"],
        },
      ]}
