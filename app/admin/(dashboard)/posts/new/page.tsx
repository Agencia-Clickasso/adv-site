      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <label className="text-sm">
            ...
            <input
              name="category"
              defaultValue="Direito Tributário"
              required
              className="w-full rounded-xl border border-custom-text-primary/20 bg-custom-bg-primary/60 px-3 py-2"
            />
          </label>
          <label className="text-sm">
            ...
            <input
              name="authorName"
              defaultValue="Dra. Lucimeire Xavier"
              required
              className="w-full rounded-xl border border-custom-text-primary/20 bg-custom-bg-primary/60 px-3 py-2"
            />
          </label>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="rounded-xl bg-custom-text-primary px-4 py-2 font-semibold text-custom-bg-secondary"
          >
            Salvar rascunho
          </button>
        </div>
