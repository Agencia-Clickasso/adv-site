...
export default function InventarioPage() {
  return (
    <AreaPage
      ...
      highlights={[
        {
          title: "Onde entra",
          description:
            "Na abertura do inventário, na partilha e na organização patrimonial preventiva.",
        },
        {
          title: "Quando cruza com tributário",
          description:
            "No ITCMD, nas avaliações, no ganho de capital e na estrutura societária familiar.",
        },
        {
          title: "Leitura prática",
          description: "Decidir a estrutura antes reduz custo, prazo e conflito entre herdeiros.",
        },
      ]}
      services={[
        {
          ...
          description:
            "Condução em cartório quando há consenso, herdeiros capazes e ausência de testamento.",
          features: [
        ...
        },
        {
          ...
          description:
            "Organização da partilha com atenção às avaliações e ao reflexo tributário dos bens.",
          features: [
            "Avaliação dos bens",
            "Partilha de imóveis",
            "Doação e usufruto",
      ...
      bridgeCta={{
        label: "Ver planejamento tributário",
        href: "/teses-e-oportunidades-tributarias#planejamento-tributario",
      }}
      ...
      relatedLinks={[
        {
          label: "Revisão das bases de cálculo de ITCMD, ITBI e ITR",
          href: "/teses-e-oportunidades-tributarias#iptu-itbi-itcmd-e-itr",
        },
        { label: "Direito civil e proteção patrimonial", href: "/areas/direito-civil" },
        {
          label: "Direito imobiliário para negócios e regularizações",
