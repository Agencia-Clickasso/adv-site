...
export default function ConsultoriaJuridicaPage() {
  return (
    <AreaPage
      ...
      highlights={[
        {
          title: "Onde ganha valor",
          description:
            "Na prevenção, na revisão de documentos e na organização de decisões que ainda podem ser corrigidas a tempo.",
        },
        {
          title: "Quando escalar",
          description:
            "Quando o tema envolve tributos, obrigações acessórias, contrato com reflexo fiscal ou reorganização empresarial.",
        },
        {
          title: "Papel da consultoria",
          description:
            "Funcionar como porta de entrada para um diagnóstico mais completo e estratégico.",
        },
      ]}
      services={[
        {
          ...
          description:
            "Análises técnicas sobre pontos específicos para orientar decisão com fundamento.",
          features: [
