...
export default function DireitoProcessualPage() {
  return (
    <AreaPage
      ...
      highlights={[
        {
          title: "Onde essa frente entra",
          description:
            "Na definição da estratégia de ação, defesa, recurso e execução com menos improviso.",
        },
        {
          title: "Quando cruza com tributário",
          description:
            "Quando a disputa envolve cobrança fiscal, defesa administrativa, garantia ou tese tributária.",
        },
        {
          title: "Ponto central",
          description: "Processo é meio de resposta, não solução isolada do problema econômico.",
        },
      ]}
      services={[
        {
          ...
          description:
            "Representação em processos judiciais com condução técnica em todas as instâncias.",
        ...
        },
        {
          ...
          title: "Recursos",
          description:
            "Formulação recursal para manter ou reverter posicionamento estratégico do caso.",
          features: [
            "Recursos ordinários",
            "Recursos especiais",
        ...
        },
        {
          ...
          title: "Execuções",
          description:
            "Atuação em execuções judiciais, inclusive quando há necessidade de reação rápida.",
          features: [
            "Execuções judiciais",
            "Execuções fiscais",
        ...
        },
        {
          ...
          description:
            "Representação perante órgãos públicos e autarquias em contencioso administrativo.",
          features: [
      ...
      relatedLinks={[
        ...
        {
          label: "Como suspender execução fiscal da empresa: medidas possíveis e o que avaliar",
          href: "/blog/como-suspender-execucao-fiscal-para-empresa",
        },
        {
