  ...
  return (
    <AreaPage
      ...
      highlights={[
        {
          ...
          description:
            "Quando há aumento de carga, cobrança inesperada, execução fiscal, dúvida sobre regime ou necessidade de rever operação e crédito tributário em São Bernardo do Campo ou no ABC.",
        },
        {
          title: "O que entra na análise",
          description:
            "Passivo fiscal, obrigações acessórias, autuações, enquadramento tributário, oportunidades de prevenção e medidas administrativas ou judiciais cabíveis.",
        },
        {
          title: "Objetivo da atuação",
          description:
            "Reduzir exposição fiscal e estruturar soluções sustentáveis para caixa, operação e patrimônio com leitura local e visão de negócio.",
        },
      ]}
      services={[
        {
          ...
          description:
            "Estratégias para revisar carga fiscal e decidir com mais segurança dentro da legalidade.",
          features: [
        ...
        },
        {
          ...
          description:
            "Resposta técnica para cobranças e execuções, buscando a melhor saída jurídica para o caso.",
          features: [
            "Defesas em execuções",
            "Acordos fiscais",
            "Suspensões de execução",
        ...
        },
        {
          ...
          description:
            "Orientação especializada para evitar problema recorrente e organizar conformidade tributária.",
          features: [
      ...
      localDetails={[
        ...
        {
          title: "Cidade-base",
          value: "São Bernardo do Campo com atendimento tributário para empresas do ABC.",
        },
        { title: "Atendimento", value: "Segunda a Sexta, das 8h às 18h. Sábado, das 8h às 12h." },
      ]}
      relatedLinks={[
        {
          label: "Teses e oportunidades tributárias analisadas pelo escritório",
          href: "/teses-e-oportunidades-tributarias",
        },
        {
          label: "Planejamento tributário para empresas: quando revisar e como reduzir riscos",
          href: "/blog/planejamento-tributario-para-empresas-como-reduzir-riscos",
        },
        {
          label: "Execução fiscal para empresas: o que fazer nos primeiros dias",
          href: "/blog/defesa-em-execucao-fiscal-estrategias-para-empresas",
        },
        {
        ...
        {
          label: "Advogada tributarista na Grande São Paulo e no interior",
          href: "/advogada-tributarista-grande-sao-paulo-e-interior",
        },
      ]}
      faqs={[
        {
