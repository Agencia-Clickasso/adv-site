...
export default function DireitoCivilPage() {
  return (
    <AreaPage
      ...
      highlights={[
        {
          title: "Onde essa área entra",
          description:
            "Na revisão contratual, em disputas patrimoniais e em conflitos que exigem previsibilidade jurídica.",
        },
        {
          title: "Quando cruza com tributário",
          description:
            "Quando a estrutura contratual ou o conflito patrimonial traz consequência fiscal para sócios ou empresa.",
        },
        {
          title: "Objetivo prático",
          description: "Reduzir desgaste, custo e improviso antes que o conflito se agrave.",
        },
      ]}
      services={[
        {
          ...
          description:
            "Elaboração, revisão e análise de contratos para proteger interesses e reduzir ruído futuro.",
          features: [
        ...
        },
        {
          ...
          description:
            "Assessoria em questões familiares com atenção a patrimônio e organização da decisão.",
      ...
      relatedLinks={[
        {
          label: "Direito empresarial em São Bernardo do Campo",
