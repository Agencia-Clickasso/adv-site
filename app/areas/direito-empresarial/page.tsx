...
export default function DireitoEmpresarialPage() {
  return (
    <AreaPage
      ...
      highlights={[
        {
          title: "Onde essa frente ajuda",
          description:
            "Constituição societária, revisão contratual, governança e adequação de operação com menor ruído jurídico.",
        },
        {
          title: "Quando cruza com tributário",
          description:
            "Mudança societária, expansão, due diligence e contratos que alteram estrutura de risco e caixa.",
        },
        {
          title: "Como a atuação entra",
          description:
            "Como apoio estratégico ao negócio, sem competir com o protagonismo tributário do escritório.",
        },
      ]}
      services={[
        {
        ...
        },
        {
          ...
          description:
            "Elaboração e revisão contratual para proteger relação comercial e operação.",
          features: [
