...
export default function DireitoPrevidenciarioPage() {
  return (
    <AreaPage
      ...
      highlights={[
        { title: "Onde entra", description: "Na revisão de recolhimentos, enquadramento de risco e benefício previdenciário." },
        { title: "Quando cruza com tributário", description: "Quando o recolhimento previdenciário pesa na carga da empresa ou na folha." },
        { title: "Leitura prática", description: "A verificação parte dos documentos e do histórico de contribuições." },
      ]}
      services={[
        {
          icon: Users,
          title: "Contribuições acima do teto",
          description: "Verificação de recolhimentos do INSS acima do teto previdenciário para profissionais com mais de um vínculo.",
          features: [
        ...
        },
        {
          ...
          description: "Revisão do grau de risco utilizado no cálculo da contribuição previdenciária.",
          features: ["GILRAT/RAT", "Revisão do FAP", "Folha de pagamento", "Indústria e serviços"],
        },
        {
          icon: FileSearch,
          title: "Contribuições sobre mão de obra",
          description: "Análise de contribuições relacionadas à cessão e tomada de mão de obra, inclusive a Lei nº 9.711/98.",
          features: ["Cessão de mão de obra", "Lei nº 9.711/98", "Documentação de recolhimento", "Recuperação tributária"],
        },
        {
          icon: Shield,
          title: "Benefícios e servidores públicos",
          description: "Avaliação de situações envolvendo prefeituras, servidores municipais e benefícios previdenciários.",
          features: ["Prefeituras e servidores", "Análise individual do caso", "Documentação previdenciária", "Medidas cabíveis"],
        },
      ]}
      ...
      relatedLinks={[
        ...
        { label: "Recuperação de créditos tributários: quem pode recuperar e cuidados", href: "/blog/recuperacao-de-creditos-tributarios-quem-pode-recuperar-e-cuidados" },
      ]}
      faqs={faqs}
    >
      <JsonLd
