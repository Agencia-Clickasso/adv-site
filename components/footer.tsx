        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
            <div className="space-y-5">
              ...
              >
                Advocacia tributária para decisões empresariais com mais clareza, menos improviso e
                melhor resposta jurídica em São Paulo, no ABC e na Grande São Paulo.
              </p>
              <p className="max-w-xl text-sm leading-7 text-custom-text-primary/76">
                Escritório com foco principal em Direito Tributário e atuação complementar em áreas
                que cercam a operação, o passivo e a estrutura jurídica do cliente.
              </p>
          ...
          <div className="mt-10 border-t border-custom-text-primary/12 pt-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {[
                {
                  label: "São Bernardo do Campo e ABC",
          ...
          <div className="mt-10 flex flex-col gap-3 border-t border-custom-text-primary/12 pt-6 text-sm text-custom-text-primary/58 sm:flex-row sm:items-center sm:justify-between">
            <p>
              &copy; {new Date().getFullYear()} Lucimeire Xavier Advocacia. Todos os direitos
              reservados.
            </p>
            <p>OAB/SP 508937</p>
          </div>
